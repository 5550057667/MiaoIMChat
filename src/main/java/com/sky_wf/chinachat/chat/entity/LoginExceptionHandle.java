...
public class LoginExceptionHandle
{
    ...
    **Bmob后台
    ...
    public static void handleErrorMsg(View view, Exception e)
    {
        ...
        {
            case USER_EXISTS:
                Utils.showLongToast(view, App.res.getString(R.string.error_user_exist));
                break;
            case USER_NOT_EXIST:
                Utils.showLongToast(view,
                        App.res.getString(R.string.error_user_not_exist));
                break;
            case INPUT_ERROR:
                Utils.showLongToast(view, App.res.getString(R.string.error_login_info));
                break;

            case EMError.USER_REMOVED:
                Utils.showLongToast(view, App.res.getString(R.string.error_account_removed));
                break;
            case EMError.USER_LOGIN_TOO_MANY_DEVICES:
                Utils.showLongToast(view, App.res.getString(R.string.error_login_too_many_device));
                break;
            case EMError.USER_ALREADY_LOGIN:
                Utils.showLongToast(view, App.res.getString(R.string.error_login_aleardy_login));
                break;
